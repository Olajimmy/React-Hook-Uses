...
// export default function Counter(props) {
//   //initiate counter st 0, setCounter lets us update the counter
//   //useState()returns an array where the first thing is the STate variable
//   //and the second is the setter fir that variable
//   const [counter, setCounter] = useState(0);
...
//     <div>
//       <h1>{counter}</h1>
//       <button onClick={addOne}>Clicke Me to Add One</button>
//       <button onClick={subtractOne}>Clicke Me to Subtract One</button>

//       <button onClick={reset}>Clicke Me to Reset</button>
//     </div>
//   );
// }
